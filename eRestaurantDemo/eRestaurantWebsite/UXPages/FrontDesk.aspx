...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <!-- This is the presetation markup code for the reservation display -->


      <div class="pull-right col-md-5">
          <!--details is a bootstrap collapasble area  -->
        <details open>
            <summary>Reservations by Date/Time</summary>
            <!--The Text Diplayed Beside the detials icons  -->
            <h4>Today's Reservations</h4>
            <!-- ItemType = parameters msut be dirted  to current aplication locations -->
            <asp:Repeater ID="ReservationsRepeater" runat="server"
             ...
             <!-- TypeName = parameters msut be dirted  to current aplication locations -->
