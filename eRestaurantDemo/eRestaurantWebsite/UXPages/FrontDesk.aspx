...
<%@ Register Src="~/UserControls/DateTimeMarker.ascx" TagPrefix="uc1" TagName="DateTimeMarker" %>



<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
     <uc1:DateTimeMarker runat="server" id="Mocker" />
                    ...
                    <asp:TemplateField HeaderText="Reservation Notes / Seat Walk-In">
                        <ItemTemplate>
                            ...
                            <asp:Panel ID="OccupiedTablePanel" runat="server"
                                    Visible='<%# Item.Taken  %>'>
                                <asp:HyperLink ID"ServingTablesLinks=" runat="server"
                                    NavigateUrl='<%string.Format("~/UXPages/ServingTables.apsx?waiter={0}&bill={1}&md={2}&mt={3}&mds={4}&mts={5}", Item.Waiter, Item.BillID, Mocker.MockDate.Ticks, Mocker.MockTime.Ticks)%>'
